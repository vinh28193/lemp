...
<nav class="navigation">
    <ul class="list-unstyled">
        ...
        <li class="has-submenu"><a href="#"><i class="fa fa-envelope-o"></i> <span class="nav-label">Components</span></a>
            <ul class="list-unstyled">
        ...
        <li class="has-submenu"><a href="#"><i class="fa fa-envelope-o"></i> <span class="nav-label">Forms</span></a>
            <ul class="list-unstyled">
        ...
        <li class="has-submenu"><a href="#"><i class="fa fa-envelope-o"></i> <span class="nav-label">Data Tables</span></a>
            <ul class="list-unstyled">
                <li><a href="tables.html">Basic Tables</a></li>
                <li><a href="table-datatable.html">Data Table</a></li>
            </ul>
        </li>
        <li class="has-submenu"><a href="#"><i class="fa fa-envelope-o"></i> <span class="nav-label">Charts</span></a>
            <ul class="list-unstyled">
        ...
        <li class="has-submenu"><a href="#"><i class="fa fa-envelope-o"></i> <span class="nav-label">Mail</span></a>
            <ul class="list-unstyled">
